    ...
    <footer className="bg-gray-800 roboto-flex h-auto  text-white py-6 mt-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4">
        ...
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6">
          <Link to="/" className="hover:text-teal-400 text-xl">Home</Link>
          <Link to="/about" className="hover:text-teal-400 text-xl">About Us</Link>
          <Link to="/all-products#top-page" className="hover:text-teal-400 text-xl">Products</Link>
          <Link to="/contact" className="hover:text-teal-400 text-xl">Contact</Link>
        </div>
