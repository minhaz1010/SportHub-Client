...
const slides: SlideData[] = [
  ...
  {
    id: 2,
    imageUrl: "https://c0.wallpaperflare.com/preview/438/719/595/photo-of-man-swinging-golf-driver.jpg",
    title: "New Arrivals",
          ...
          <div className="absolute inset-5  flex items-center justify-center">
            <Card className="md:w-[800px]   w-[600px] teko ">
              <CardContent className="p-6 ">
                ...
                <Button variant="default" className='mt-5 text-2xl bg-sky-500 hover:bg-sky-800 py-6'><Link to="/all-products">All Products</Link>
</Button>
              </CardContent>
            </Card>
          </div>
