...
const AllProducts: React.FC = () => {
  ...
  const totalPages = Math.ceil(data?.data.totalItem as number / queryParams.limit) || 1;
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    setQueryParams({ ...queryParams, search: e.target.value, category: '', brand: '', rating: 0, sort: '' });
  };
    ...
    <div className="top-page container mx-auto px-4 py-8">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/4 space-y-6 roboto-flex">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <Select onValueChange={handleLimitChange} value={queryParams.limit === 0 ? '10' : queryParams.limit.toString()}>
                <SelectTrigger>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <Select onValueChange={handleCategory} value={queryParams.category}>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <Select onValueChange={handleRating} value={queryParams.rating.toString()}>
                <SelectTrigger>
        ...
        <div className="w-full lg:w-3/4">
          {isLoading && <Loading />}
          {isError && <p className='text-4xl text-red-600'>Some Error Occured</p>}
          {
            products.length ? (
              <>
                ...
                <div className="flex justify-center mt-6">
                  ...
                  <div className="flex items-center">
                    {Array.from({ length: totalPages }, (_, index) => (
                      <Button
                        key={index}
                        variant={queryParams.page === index + 1 ? "default" : "outline"}
              ...
              <div className='text-5xl text-red-400 text-center'>No Product Found</div>
            )
          }
        </div>
